        ...
        <div>
            <center>
                <form onSubmit={ insertArchive }>
                    ...
                    <input type='file' required={true} accept='image/png, image/jpeg' onChange={(e) => uploadImgProfile(e.target.files[0])} /> <br/> 
                    <h5>Foto de portada: </h5> <br/>
                    <input type='file' required={true} accept='image/png, image/jpeg' onChange={(e) => uploadImgBackground(e.target.files[0])}/> <br/>
                    <input type='submit'/>
                </form>   
            </center>
        </div>
